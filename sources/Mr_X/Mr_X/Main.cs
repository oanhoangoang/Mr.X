    ...
    public partial class Main : Form
    {
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            if (levelClick <= nowLevel)
            {
                if (levelClick == 1)
                {
                    FstCalDisp g = new FstCalDisp(1, "Bảo vệ", "1", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                ...
                {
                    frmCalExpression g = new frmCalExpression(1, "Bảo vệ", "2", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 3)
                {
                    FindNumDisplay g = new FindNumDisplay(3, "Bảo vệ", 6, 8, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 4)
                {
                    RememberMe g = new RememberMe(4, "Vẫn chỉ là bảo vệ", 5, 7, 12, 30, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 5)
                {
                    FindSameCell g = new FindSameCell(5, "Bảo vệ", 4, 5, 8, 40, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 6)
                {
                    FrmPrime g = new FrmPrime(1, "Nhân viên lễ tân", "6", 20, sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 7)
                {
                    LgImgDisp g = new LgImgDisp(1, "Nhân viên lễ tân", "7", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 8)
                {
                    FstCalDisp g = new FstCalDisp(2, "Nhân viên lễ tân", "8", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 9)
                {
                    orderButton g = new orderButton(9, "Nhân viên lễ tân", 4, 6, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 10)
                {
                    ArrMscDisp g = new ArrMscDisp(1, "Nhân viên lễ tân", "10", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 11)
                {
                    frmCalExpression g = new frmCalExpression(2, "Chuyên viên Marketing", "2", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 12)
                {
                    FindNumDisplay g = new FindNumDisplay(12, "Chuyên viên Marketing", 8, 15, 90, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 13)
                {
                    RememberMe g = new RememberMe(13, "Chuyên viên Marketing", 6, 9, 15, 30, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 14)
                {
                    FindSameCell g = new FindSameCell(14, "Chuyên viên Marketing", 5, 6, 16, 50, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 15)
                {
                    FindDifferentCell g = new FindDifferentCell(15, "Chuyên viên Marketing", 5, 1, 3, 10, 75, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 16)
                {
                    CatchTheWord g = new CatchTheWord(16, "Trưởng phòng tạp vụ", 8, 8, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 17)
                {
                    LgImgDisp g = new LgImgDisp(2, "Trưởng phòng tạp vụ", "17", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                ...
                {
                    ArrMscDisp g = new ArrMscDisp(2, "Trưởng phòng tạp vụ", "19", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 20)
                {
                    orderButton g = new orderButton(20, "Trưởng phòng tạp vụ", 6, 8, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 21)
                {
                    FstCalDisp g = new FstCalDisp(2, "Trưởng phòng hành chính", "21", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 22)
                {
                    CatchTheWord g = new CatchTheWord(16, "Trưởng phòng hành chính", 8, 8, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 23)
                {
                    ArrMscDisp g = new ArrMscDisp(2, "Trưởng phòng hành chính", "23", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 24)
                {
                    followArrow g = new followArrow(24, "Trưởng phòng hành chính", 40, 30, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 25)
                {
                    FstCalDisp g = new FstCalDisp(2, "Trưởng phòng hành chính", "25", sound);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 26)
                {
                    FindSameCell g = new FindSameCell(26, "Phó giám đốc", 6, 7, 42, 120, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 27)
                {
                    orderButton g = new orderButton(27, "Phó giám đốc", 6, 13, 60, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                else if (levelClick == 28)
                {
                    followArrow g = new followArrow(28, "Phó giám đốc", 80, 45, sound, 1);
                    g.trans = data;
                    g.ShowDialog();
                }
                ...
                else if (levelClick == 30)
                {
                    FrmPzGame g = new FrmPzGame(sound, 30, "Cố vấn Tổng giám đốc");
                    g.trans = data;
                    g.ShowDialog();
                }
